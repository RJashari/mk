...
public class GjeneroAddPdf {
	...
	public String gjeneroAddPdf(Dega dega) throws ParseException, IOException, NoSuchProviderException {
		Properties properties = System.getProperties();
        properties.load(GjeneroPdf.class.getClassLoader().getResourceAsStream("application.properties"));
		locationForPdf = properties.getProperty("locationForPdfShtoDegen");
        ...
        headerParagraf.add("Është shtuar dega "+dega.getEmri()+" nga "+emriAdmin);//statement
        }else {
        	 headerParagraf.add("Është shtuar dega "+dega.getEmri()+" nga "+this.getEmriMbiemri(user));//statement
        }
...
//        Table t4 = new Table(new float[]{80.0f, 100.0f, 40.0f, 80.0f});
		...
		cell.add(new Paragraph("Dega e shtuar: "+dega.getEmri())
				.setPaddingTop(10.0f)
				.setBorder(Border.NO_BORDER)
                .setFontSize(8.0f));
		t2.addCell(cell);
		...
		t1.addCell(cell);
    		...
    		cell = this.getCellWithDefaultParametersUpper();
    		cell.add(new Paragraph("Shtimi i degës: "+dega.getEmri())
    				.setPaddingTop(10.0f)
    				.setBorder(Border.NO_BORDER)
                    .setFontSize(8.0f));
    		t2.addCell(cell);
...
//                	.addCell(this.getCellWithDefaultParameters().add(dega.getEmri()+"").setFontSize(8.0f).setTextAlignment(TextAlignment.RIGHT))
...
//            LOGGER.info("Failed to generate a mime message for  " + principal.getName()  + " for Branch " + dega.getEmri()+ e);
//        }
//        return message;
//    }
