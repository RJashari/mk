...
public class GjeneroPdf {
	...
	public String gjeneroPdf(Dega dega) throws ParseException, IOException, NoSuchProviderException {
		...
		String emailToPergjegjesi = dega.getPergjegjesi();
		String subjectEmail = "Modifikimi i degës";
		String bodyEmail ="Modifikimi i degës \""+dega.getEmri()+"\" në datën: "+dayOfModification; 
        ...
        if(user.equals("admin")){
        	...
        	headerParagraf.add("Modifikimi i Deges "+dega.getEmri()+" nga "+emriAdmin);//statement
        }else {
        headerParagraf.add("Modifikimi i Deges "+dega.getEmri()+" nga "+this.getEmriMbiemri(user));//statement
        }
